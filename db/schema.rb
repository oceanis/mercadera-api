...
ActiveRecord::Schema.define(version: 20150323011749) do
  ...
  add_index "listing", ["location_id"], name: "index_listing_on_location_id", using: :btree
  add_index "listing", ["subcategory_id"], name: "index_listing_on_subcategory_id", using: :btree
